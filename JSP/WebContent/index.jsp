...
<form class="disp" action="insert.jsp" id="add" style="display:none;">
<input name="name" type="text" value="Name"><br>
<input name="pass" type="text" value=""><br>
<button type="submit">Submit</button>
</form>
<form action="delete.jsp" id="del" style="display:none" class="disp">
<input name="name" type="text" value="Name"><br>
<input name="pass" type="hidden" value="">
<button type="submit">Submit</button>
</form>
<form action="update.jsp" id="up" style="display:none;" class="disp">
<input name="name" type="text" value="Name"><br>
<input name="pass" type="text" value=""><br>
<button type="submit">Submit</button>
</form>
